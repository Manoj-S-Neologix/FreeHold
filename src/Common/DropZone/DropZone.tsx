...
// import ClientService from '../../webparts/freehold/Services/Business/ClientService';
// interface DragAndDropUploadProps {
//     onFilesAdded: (files: File[]) => void;
//     setIsError?: React.Dispatch<React.SetStateAction<boolean>>;
//     setFiles?: React.Dispatch<React.SetStateAction<File[]>>;
...
//                     <ul>
//                         {files && files.length > 0 && files.map((file: any, index: any) => (
//                             <li key={index}  style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
//                                 <span>{file.name}</span>
//                                 <Box sx={{ minWidth: 120 }}>
//                                 <Select
